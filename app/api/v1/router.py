...
from app.api.v1.endpoints import auth, teachers, payments, webhooks, matching, schools, applications, signup, blog, jobs, admin, school_accounts, school_jobs, school_signup, school_selections
...
api_router.include_router(school_selections.router, prefix="/school-selections", tags=["school-selections"])
